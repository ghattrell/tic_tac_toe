...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { cell_chosen: @move.cell_chosen, player_id: @move.player_id, symbol: @move.symbol }
    end
  ...
  test "should update move" do
    put :update, id: @move, move: { cell_chosen: @move.cell_chosen, player_id: @move.player_id, symbol: @move.symbol }
    assert_redirected_to move_path(assigns(:move))
  end
